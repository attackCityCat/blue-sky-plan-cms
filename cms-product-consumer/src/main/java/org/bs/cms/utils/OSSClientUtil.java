...
public class OSSClientUtil {
    ...
    // accessKey
    private String accessKeyId = "LTAIDIRbF7mkczzs";
    private String accessKeySecret = "cqJIutyu46GpumvqTmEaXR9SWdh9wO";
    // 空间
    private String bucketName = "dongge520";
    // 文件存储目录
    private String filedir = "dongge520/";
